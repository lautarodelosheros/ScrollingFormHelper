...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ScrollingFormHelper.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/lautarodelosheros/ScrollingFormHelper'
  ...
  # s.resource_bundles = {
  #   'ScrollingFormHelper' => ['ScrollingFormHelper/Assets/*.png']
  # }
